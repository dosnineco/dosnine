...
const Hero = () => {
  return (
    ...
    {/* Buy Template Button */}
    <button className="relative  text-black text-sm  font-bold py-4 sm:py-3 px-4 rounded  w-auto">
      <a href="https://7617327545561.gumroad.com/l/yrccb">Buy Template</a>
      <div className="box-shadow  absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-25 "></div>
    </button>

    {/* Register Here Button */}
    <button className="box-shadow relative  bg-primary-color text-white text-sm  font-bold py-4 sm:py-3 px-4  rounded w-auto">
      <a href="/register">Register Here</a>
      <div className=" absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-25 "></div>
