    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:grid-cols-1">
          <Link className="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100" href="/website-traffic">
          ...
          <Link className="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100" href="/texttoexcel">
          ...
          <Link className="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100" href="/quote">
          ...
          <Link className="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100" href="/email-template">
          ...
          <Link className="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100" href="/salary-to-hourly">
